...
if global.currentArtPage = 5 {
	text0 = "Select the most suitable description";
		...
		switch (keyboard_key) {
		case vk_numpad1: global.selectedText = 1; break;
		case vk_numpad2: global.selectedText = 2; break;
		case vk_numpad3: global.selectedText = 3; break;
		} 
		
		if (global.selectedText == 1 ) {global.selectedTextArt5 = text1}
		else if (global.selectedText == 1 ) {global.selectedTextArt5 = text2}
		else if (global.selectedText == 1 ) {global.selectedTextArt5 = text3};
	...
	text0 = "Select the most suitable description";
		...
		if (global.selectedText == 1) {global.selectedTextArt4 = text1}
		else if (global.selectedText == 1) {global.selectedTextArt4 = text2}
		else if (global.selectedText == 1) {global.selectedTextArt4 = text3};
		...
		if (global.selectedText == 1) {global.selectedTextArt3 = text1}
		else if (global.selectedText == 1) {global.selectedTextArt3 = text2}
		else if (global.selectedText == 1) {global.selectedTextAr3 = text3};
	...
	text0 = "Select the most suitable description";
		...
		if (global.selectedText == 1) {global.selectedTextArt2 = text1}
		else if (global.selectedText == 1) {global.selectedTextArt2 = text2}
		else if (global.selectedText == 1) {global.selectedTextAr2 = text3};
	...
	text0 = "Select the most suitable description";	
		...
		if (global.selectedText == 1) {global.selectedTextArt1 = text1}
		else if (global.selectedText == 1) {global.selectedTextArt1 = text2}
		else if (global.selectedText == 1) {global.selectedTextAr1 = text3};
